...
define SWIFT_CONFIGURE_CMDS
	...
	echo 'set(CMAKE_C_COMPILER $(SWIFT_NATIVE_PATH)/usr/bin/clang)' >> $(SWIFT_CMAKE_TOOLCHAIN_FILE)
    echo 'set(CMAKE_CXX_COMPILER $(SWIFT_NATIVE_PATH)/usr/bin/clang++)' >> $(SWIFT_CMAKE_TOOLCHAIN_FILE)
    ...
    echo 'set(SWIFT_NATIVE_CLANG_TOOLS_PATH $(SWIFT_NATIVE_PATH)/usr/bin)' >> $(SWIFT_CMAKE_TOOLCHAIN_FILE)
	echo 'set(SWIFT_NATIVE_LLVM_TOOLS_PATH $(SWIFT_NATIVE_PATH)/usr/bin)' >> $(SWIFT_CMAKE_TOOLCHAIN_FILE)
    echo 'set(SWIFT_NATIVE_SWIFT_TOOLS_PATH $(SWIFT_NATIVE_PATH)/usr/bin)' >> $(SWIFT_CMAKE_TOOLCHAIN_FILE)
	...
	echo 'set(LibRT_LIBRARIES ${STAGING_DIR}/usr/lib/librt.so)' >> $(SWIFT_CMAKE_TOOLCHAIN_FILE)
