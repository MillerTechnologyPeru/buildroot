...
SWIFT_TARGET_FLAGS="--sysroot=${STAGING_DIR_TARGET} -target $(GNU_TARGET_NAME)"
EXTRA_INCLUDE_FLAGS="-I${STAGING_DIR_TARGET}/usr/include/c++/${SWIFT_CXX_VERSION} -I${STAGING_DIR_TARGET}/usr/include"
RUNTIME_FLAGS="-w -fuse-ld=lld ${TARGET_FLAGS} -B${STAGING_DIR_TARGET}/usr/lib -B${STAGING_DIR_TARGET}/lib"
...
define SWIFT_INSTALL_TARGET_CMDS
	cd $(SWIFT_BUILDDIR)
	mkdir $(TARGET_DIR)/usr/lib/swift
	mkdir $(TARGET_DIR)/usr/lib/swift/linux
